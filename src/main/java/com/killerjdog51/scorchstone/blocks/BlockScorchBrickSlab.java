 ...
 *
 */
public abstract class BlockScorchBrickSlab extends BlockSlab {
	...
	public BlockScorchBrickSlab(Material materialIn) {
		super(materialIn);
    ...
    public final Item getItemDropped(
        ...
        return Item.getItemFromBlock(ScorchstoneBlocks.brickSlab);
    }
