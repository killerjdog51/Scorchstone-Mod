 ...
 *
 */
public abstract class BlockScorchCobbleSlab extends BlockSlab {
	...
	public BlockScorchCobbleSlab(Material materialIn) {
		super(materialIn);
    ...
    public final Item getItemDropped(
        ...
        return Item.getItemFromBlock(ScorchstoneBlocks.cobbleSlab);
    }
