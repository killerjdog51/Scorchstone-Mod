 ...
 *
 */
public class ItemScorchBrickSlab extends ItemSlab {
    /**
     ...
     */
    public ItemScorchBrickSlab(
        final Block block,
        final BlockHalfScorchBrickSlab slab,
        final BlockDoubleScorchBrickSlab doubleSlab,
