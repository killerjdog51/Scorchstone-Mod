 ...
 *
 */
public class ItemScorchCobbleSlab extends ItemSlab {
    /**
     ...
     */
    public ItemScorchCobbleSlab(
        final Block block,
        final BlockHalfScorchCobbleSlab slab,
        final BlockDoubleScorchCobbleSlab doubleSlab,
